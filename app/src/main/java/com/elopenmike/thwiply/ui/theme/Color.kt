...
val ElectricBlueOnPrimaryContainerLight = Color(0xFF001F26)

val ElectricBlueSecondaryLight = Color(0xFF4B6269)
val ElectricBlueOnSecondaryLight = Color(0xFFFFFFFF)
val ElectricBlueSecondaryContainerLight = Color(0xFFCEE7EE)
val ElectricBlueOnSecondaryContainerLight = Color(0xFF061E24)

val ElectricBlueTertiaryLight = Color(0xFF006686)
val ElectricBlueOnTertiaryLight = Color(0xFFFFFFFF)
val ElectricBlueTertiaryContainerLight = Color(0xFFBFE8FF)
val ElectricBlueOnTertiaryContainerLight = Color(0xFF001E2B)

val ElectricBlueBackgroundLight = Color(0xFFF5FAFC)
val ElectricBlueOnBackgroundLight = Color(0xFF171D1E)
val ElectricBlueSurfaceLight = Color(0xFFFFFFFF)
val ElectricBlueOnSurfaceLight = Color(0xFF171D1E)
val ElectricBlueSurfaceVariantLight = Color(0xFFDBE4E7)
